...
class Park_classifier():
    ...
    def s_read_position(self, car_park_positions_path:pickle)->list:
    ...
    def classify(self, image:np.ndarray, prosessed_image:np.ndarray,threshold:int=100000)->np.ndarray:
        ...
        for x, y in self.car_park_positions:
            ...
            # classifying according to the threshold value to updating counts and setting drawing params
